...
class TimetableGroup(models.Model):
    ...
    even_week = models.ManyToManyField(Day, verbose_name='Четная неделя', related_name='even_week')
    odd_week = models.ManyToManyField(Day, verbose_name='Нечетная неделя', related_name='odd_week')
