# Generated by Django 3.1.5 on 2021-01-11 17:02

from django.db import migrations, models
import django.db.models.deletion
from apps.informing.models import Topic


def create_topics(apps, chema_editor):
    Topic.objects.create(
        name='allUsers_ios',
        description='Все пользователи IOS смартфонов'
    )
    Topic.objects.create(
        name='allUsers_android',
        description='Все пользователи Android смартфонов'
    )
